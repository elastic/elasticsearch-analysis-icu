...
public abstract class AbstractTermsFacetComparator implements TermsFacetComparator {
    ...
    public AbstractTermsFacetComparator setLocale(ULocale locale) {
        this.locale = locale;
        return this;
    }
    ...
    public static TermsFacetComparator getInstance(String type, boolean reverse, ULocale locale, String rules, int decomp, int strength) {
        if (locale == null) {
            locale = ULocale.getDefault();
        }
